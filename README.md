...
2. CODESPTB - Construção de Árvore Binária de Busca e impressão em pré-ordem
   Arquivo: CODESPTB.cpp

3. BSEARCH1 - Implementação manual da busca binária
   Arquivo: BSEARCH1.cpp
